 ...
 (function(factory) {
  ...
  var TitleOverlayPlugin = function(player, options) {
      ...
      var createOverlayContainer_ = function() {
          ...
          this.titleOverlayTextContainer.style.backgroundColor = 'rgba(0,0,0,.6)'         
          ...
          this.titleOverlaySubTextContainer = this.titleOverlayContainer.appendChild(document.createElement('div'));
          this.titleOverlaySubTextContainer.style.backgroundColor = 'rgba(0,0,0,.6)'
          this.titleOverlaySubTextContainer.textContent = options.subTitle || '';
          this.titleOverlaySubTextContainer.style.position = 'relative';
          this.titleOverlaySubTextContainer.style.margin = options.subtitleMargin || title_defaults.margin;
          this.titleOverlaySubTextContainer.style.fontSize = options.subtitleFontSize || title_defaults.fontSize;
          this.titleOverlaySubTextContainer.style.textShadow = '0 0 5px #000';
          showOverlay_();
      }.bind(this);
