(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined'
		...
		: ((global = global || self),
		  (global['videojs-http-source-selector'] = factory(global.videojs)));
		...
		(function (_MenuButton) {
			...
			function SourceMenuButton(player, options) {
				...
				_this
					...
					.qualityLevels()
					.on(
						['change', 'addqualitylevel'],
						videojs.bind(_assertThisInitialized(_this), _this.update)
					);
	...
	var onPlayerReady = function onPlayerReady(player, options) {
		...
		player.on(['loadedmetadata'], function (e) {
			...
			if (
				...
				controlBar.el().appendChild(sourceSelector.el());
			}
		});
	};
	/**
